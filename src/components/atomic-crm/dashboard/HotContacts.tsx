      ...
      <div className="flex items-center">
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>{translate("crm.create_contact")}</TooltipContent>
          </Tooltip>
        </TooltipProvider>
      </div>
      <Card className="py-0">
          ...
          empty={
            <div className="p-4">
              <p className="text-sm mb-4">
                {translate("crm.hot_contacts_hint")}
              </p>
              <p className="text-sm">
                {translate("crm.hot_contacts_empty_extra")}
              </p>
            </div>
          }
        />
